...
import type { CliConfig } from '../commands/config/config.schemas';
import * as p from '@clack/prompts';
import pc from 'picocolors';
import { exit, exitOnCancel } from '../prompts/utils';

export async function promptForOrganization({ apiClient, organizations }: { apiClient: Client; organizations: { id: string; name: string }[] }) {
